  ...
  <div>
    ...
    <div class="all_infor">
      ...
      <div class="left">
        ...
        <div class="infor">
          ...
          <div class="vice">
            ...
            <span class="time">{{this.inforObj.issueDate}}</span>
          ...
          <div v-html="this.inforObj.text" id="image" style="width: 100%"></div>
      ...
      <div class="right">
        <!-- 个人信息 -->
        <div class="user">
          <div class="image" @click="userMain(user.id)"><img :src="this.user.headPic" alt=""></div>
...
export default {
  ...
  methods: {
    ...
    async getInfor () {
      ...
      this.inforObj.text = res.object.text
    ...
    async submit () {
      ...
      const res = await this.$http.post('/Infor/addComment', {
        userId: Cookie.get('ID'),
        text: this.textarea,
        informationId: this.inforObj.nId
      })
