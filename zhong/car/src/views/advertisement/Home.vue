    ...
    <div class="userForm">
      ...
      <div class="item">
        ...
        <el-select v-model="formInline.dealer" style="width: 45%" placeholder="请选择">
          <el-option label="安徽亚达汽车销售服务有限公司" value="安徽亚达汽车销售服务有限公司"></el-option>
          <el-option label="安徽伟新行汽车销售服务有限公司" value="安徽伟新行汽车销售服务有限公司"></el-option>
          <el-option label="合肥市贺悦汽车销售服务有限公司" value="合肥市贺悦汽车销售服务有限公司"></el-option>
        </el-select>
      </div>
      <div class="btn">
