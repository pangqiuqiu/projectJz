    ...
    <div class="userForm">
      ...
      <div class="item">
        ...
        <el-select v-model="formInline.dealer" style="width: 45%" placeholder="请选择">
          <el-option label="温州将军汽车销售服务有限公司" value="温州将军汽车销售服务有限公司"></el-option>
          <el-option label="温州将军乐清直营店" value="温州将军乐清直营店"></el-option>
          <el-option label="温州华腾汽车销售服务有限公司" value="温州华腾汽车销售服务有限公司"></el-option>
          <el-option label="苍南县荣睿汽车销售服务有限公司" value="苍南县荣睿汽车销售服务有限公司"></el-option>
          <el-option label="温州华祺汽车销售服务有限公司" value="温州华祺汽车销售服务有限公司"></el-option>
        </el-select>
      </div>
      <div class="btn">
